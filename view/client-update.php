...
<?php include  $_SERVER['DOCUMENT_ROOT'] . '/acme/common/header.php'; ?>
        ...
        <main>
            <div id="login">
                ...
                ?>
                <form action="/acme/accounts/" method="post">
                    <span>By entering a password, your current password WILL be changed!</span><br>
                    <span>Passwords must be at least 8 characters and contain at least 1 number, capital letter, and special character</span><br>
